                        ...
                        <div className="rounded-md shadow-sm -space-y-px">
                            <div className="mb-4 relative">
                                ...
                                <input
                                    ...
                                    autoComplete="email"
                                    required
                                    className="appearance-none rounded-lg relative block w-full pl-10 px-3 py-2 border border-input placeholder-muted-foreground bg-background text-foreground focus:outline-none focus:ring-primary focus:border-primary sm:text-sm"
